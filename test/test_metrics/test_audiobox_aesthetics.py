...
from versa.utterance_metrics.audiobox_aesthetics_score import (
    ...
    is_audiobox_aesthetics_available,
)
...
# -------------------------------
@pytest.mark.skipif(
    not is_audiobox_aesthetics_available(), reason="AudioBox Aesthetics not available"
)
...
def test_utterance_audiobox_aesthetics(batch_size, precision, use_gpu, fixed_audio):
    ...
    """
    config = {"batch_size": batch_size, "precision": precision, "use_gpu": use_gpu}
